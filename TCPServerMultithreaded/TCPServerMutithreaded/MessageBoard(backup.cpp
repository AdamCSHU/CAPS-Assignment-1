...
std::string MessageBoard::trun(std::string message, int length)
{
...
std::string MessageBoard::listMessage()
{
...
int MessageBoard::countMessage(std::string topicID) {
...
int MessageBoard::postMessage(std::string topicID, std::string message) {
...
std::string MessageBoard::readMessage(std::string topicID, int postID) {
	std::string topicAdjust = trun(topicID, 140);
	lock.lock_shared();
